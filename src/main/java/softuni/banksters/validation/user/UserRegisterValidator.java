package softuni.banksters.validation.user;
...
import softuni.banksters.validation.ValidationConstants;
import softuni.banksters.validation.annotation.Validator;
...
public class UserRegisterValidator implements org.springframework.validation.Validator {
    ...
    public void validate(Object o, Errors errors) {
        ...
        if (userRegisterBindingModel.getUsername().length() < 2 || userRegisterBindingModel.getUsername().length() > 20) {
            errors.rejectValue(
                    "username",
